FRAME_CATALOG: dict[str, dict[str, any]] = {
    "油絵額縁 8235(Oil painting frame 8235)": {
        ...
        "variants": [
            {"color": "ホワイト",  "preview_img_landscape": "frames/8235_white_landscape.png",  "preview_img_portrait": "frames/8235_white_portrait.png"},
    ...
    "油絵額縁 8117(Oil painting frame 8117)": {
        "overlay_inset": 19,
        "variants": [
            {"color": "ストーングレー", "preview_img_landscape": "frames/8117_stone_landscape.png", "preview_img_portrait": "frames/8117_stone_portrait.png"},
        ],
        "sizes": {
    ...
    "油絵額縁 レインボー(Oil painting frame, Rainbow)": {
        "overlay_inset": 18,
        "variants": [
            {"color": "金 (Gold)",    "preview_img_landscape": "frames/rainbow_gold_landscape.png",   "preview_img_portrait": "frames/rainbow_gold_portrait.png"},
            {"color": "銀 (Silver)",  "preview_img_landscape": "frames/rainbow_silver_landscape.png", "preview_img_portrait": "frames/rainbow_silver_portrait.png"},
        ],
        "sizes": {
