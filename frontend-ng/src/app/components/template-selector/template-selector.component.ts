...
export class TemplateSelectorComponent {
  ...
  /** Large portrait carousel cards (generate “Preset” row). */
  @Input() presetLayout = false;
  /** Hide inline title when parent already shows a step label (avoids duplicate headings). */
  @Input() hideExploreTitle = false;
